...
export const MOCK_ACCOUNT_TRANSACTION_DESCS: MockAccountsTransactionDesc[] = [
  ...
  // new MockUnitTransactionDesc(15, 2, 'Cheque Book Request'),
  // new MockUnitTransactionDesc(16, 2, 'Cheque Book Request Status'),
  // new MockUnitTransactionDesc(17, 2, 'Cheque History'),
  // new MockUnitTransactionDesc(18, 3, 'Apply for Product'),
  // new MockUnitTransactionDesc(19, 3, 'Contact Bank'),
  // new MockUnitTransactionDesc(20, 3, 'Flexi'),
  // new MockUnitTransactionDesc(21, 3, 'Hala Top Up'),
  // new MockUnitTransactionDesc(22, 3, 'Kahramaa Bill Payment'),
  // new MockUnitTransactionDesc(23, 3, 'Ocard'),
  // new MockUnitTransactionDesc(24, 3, 'Ooredoo'),
  // new MockUnitTransactionDesc(25, 3, 'Ooredoo Bills'),
  // new MockUnitTransactionDesc(26, 3, 'QCool'),
  // new MockUnitTransactionDesc(27, 3, 'Qcool Bills'),
  // new MockUnitTransactionDesc(28, 3, 'Qpost Bills'),
  // new MockUnitTransactionDesc(29, 3, 'Save Bill'),
  // new MockUnitTransactionDesc(30, 3, 'School'),
  // new MockUnitTransactionDesc(31, 3, 'School Payment'),
  // new MockUnitTransactionDesc(31, 3, 'School Payment Soft Launch'),
  // new MockUnitTransactionDesc(32, 3, 'Test New Partner'),
  // new MockUnitTransactionDesc(33, 3, 'View paiment history'),
  // new MockUnitTransactionDesc(34, 3, 'Voda bill pay'),
  // new MockUnitTransactionDesc(35, 3, 'Vodafone'),
  // new MockUnitTransactionDesc(36, 3, 'WOQOD'),
  // new MockUnitTransactionDesc(37, 4, 'IPO Subscription'),
];
